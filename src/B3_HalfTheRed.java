public class B3_HalfTheRed extends World {
    ...
    public void go() {
        ...
        for (int row = 1; row < 389; row = row + 1) {
            for (int col = 1; col < 598; col++) {
...
//                plane.teleport(col, 488 - row);
                if(red > 170 && red < 190 && green == 0 && 45 < blue && blue < 50){
                    System.out.println("red not zero!");
                    plane.setPixelColor(0, 0, 255);
                }
                if(red == 255 && green == 255 && blue == 255 && row < 125 && row > 75 && col < 335 && col > 80){
